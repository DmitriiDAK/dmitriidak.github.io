...
![Псевдо-ComfyUI](assets/og-preview.webp) 
...
![Кейсы 3D-карусель](assets/Cases.webp) 
...
- Terminal & Forms: Блок обратной связи, стилизованный под Windows CMD (system32/cmd.exe), с анимацией печати и валидацией данных.
  ![Футер сайта](assets/Footer.webp)
...
![Игра](assets/CatGame1.webp) 
![Конец игры](assets/CatGame2.webp) 
