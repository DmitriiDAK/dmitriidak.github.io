...
(function () {
  ...
  var tr = [
    ...
    ['.hero p.subtitle',                 0,
      'Специализация: AI (Wireflow/ComfyUI/InvokeAI/LM Studio/OpenCode), граф- и web дизайн, моушн, пост-прод, методология и обучение команд.',
      'Specialization: AI (Wireflow/ComfyUI/InvokeAI/LM Studio/OpenCode), graphic & web design, motion, post-production, methodology and team training.'],
   ...
   ['#pet-labs-title',        0, 'Pet-проекты', 'Pet Projects'],

   /* Card 1: AI Music */
   ['#pet-name-1',            0, 'AI Музыка', 'AI Music'],
   ['#pet-desc-1',            0, 'Экспериментальный альбом с инструменталом на базе нейросетей. Авторский текст и голос с AI-обработкой.', 'Experimental album with instrumentals generated by neural networks. Original lyrics and AI-processed vocals.'],
   ['#pet-ready-1',           0, 'Готовность 100%', 'Ready 100%'],

   /* Card 2: Domkom */
   ['#pet-name-2',            0, 'Domkom (Steam)', 'Domkom (Steam)'],
   ['#pet-desc-2',            0, 'RPG с элементами стратегии на Godot Engine. Генерация диалогов в реальном времени + управление домом.', 'RPG with strategy elements built in Godot Engine. Real-time dialogue generation + home management.'],
   ['#btn-steam-text',        0, 'Страница в Steam', 'Steam Page'],
   ['#pet-ready-2',           0, 'Готовность 10%', 'Ready 10%'],
